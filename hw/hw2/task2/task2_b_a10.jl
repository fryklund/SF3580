...
plot!(real(circ),imag(circ),xlims = (minimum(real(circ)),maximum(real(circ))),ylims =(minimum(imag(circ)),maximum(imag(circ))),label=["C ( c,\\rho )" "\\lambda"],title= title_string)

savefig("Task2_b_a10_1.png")
## Plot r_log
...
plot!(real(circ_2),imag(circ_2),xlims = (minimum(real(circ)),maximum(real(circ))),ylims =(minimum(imag(circ)),maximum(imag(circ))),label=["C ( c,\\rho )" "\\lambda"],title= title_string)
savefig("Task2_b_a10_2.png")
## Plot r_log
