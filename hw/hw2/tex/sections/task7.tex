...
It is given that all eigenvalues are contained in the disc centered at $c$ with radius $\rho$. By taking the modulus the inequality   \eqref{eq:7f} and assumin $\lambda_{1}\neq0$ we get
\begin{align*}
